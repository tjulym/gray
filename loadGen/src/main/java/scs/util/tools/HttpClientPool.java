...
public class HttpClientPool {
	...
	public static void main(String[] args) {
		...
		String queryItemsStr=Repository.yamNetBaseURL;
		String jsonParmStr=Repository.yamNetParmStr;
		queryItemsStr=queryItemsStr.replace("Ip", "192.168.1.105");
		queryItemsStr=queryItemsStr.replace("Port", "30107");
		System.out.println(instance.postResponseTime(httpClient, queryItemsStr, jsonParmStr));
		System.out.println(instance.postResponseTime(httpClient, queryItemsStr, jsonParmStr));
		System.out.println(instance.postResponseTime(httpClient, queryItemsStr, jsonParmStr));
		System.out.println(instance.postResponseTime(httpClient, queryItemsStr, jsonParmStr));
