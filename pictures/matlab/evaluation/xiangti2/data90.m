...
% bone_class_f6=[data6(:,1)]; 
% G_f6 = [zeros(size(data6(:,1)))+1]; 
...
% box6 = boxplot(bone_class_f6,G_f6,'Colors','kkkk','positions',1.2,'width',0.1,'symbol','');
%  
% bone_class_f7=[data7(:,1)];
% G_f7 = [zeros(size(data7(:,1)))+1]; 
...
% box7 = boxplot(bone_class_f7,G_f7,'Colors','kkkk','positions',1.3,'width',0.1,'symbol','');
...
set(gca,'XTickLabel',{'99th latency'},'Fontsize',fontsize);
