...
set(gca,'YLim',[0 4])
set(gca,'YTick', [0:1:4]); % 添加X轴的记号点
set(gca,'yTickLabel',[0:1:4]*100,'Fontsize',fontsize);
...
set(ll,...
    'Position',[0.101109927527529 0.811721102376541 0.577499992288649 0.111999997138977],...
