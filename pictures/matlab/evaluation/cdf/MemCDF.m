...
gs=textread('D:\MatlabWorkspaces\paper\ISCA\ISCA-paper\cdf\Mem\GsightMem.txt','%f');
py=textread('D:\MatlabWorkspaces\paper\ISCA\ISCA-paper\cdf\Mem\PythiaMem.txt','%f');
wf=textread('D:\MatlabWorkspaces\paper\ISCA\ISCA-paper\cdf\Mem\WorstFitMem.txt','%f');
