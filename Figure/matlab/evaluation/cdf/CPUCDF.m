...
gs=textread('D:\MatlabWorkspaces\paper\ISCA\ISCA-paper\cdf\CPU\GsightCPU.txt','%f');
py=textread('D:\MatlabWorkspaces\paper\ISCA\ISCA-paper\cdf\CPU\PythiaCPU.txt','%f');
wf=textread('D:\MatlabWorkspaces\paper\ISCA\ISCA-paper\cdf\CPU\WorstFitCPU.txt','%f');
...
set(gca,'XLim',[0 1]);
set(gca,'XTick',[0: 0.2: 1], 'Fontsize',fontsize1)
...
xlabel('CPU Util. (%)','Fontsize' ,fontsize)
