...
plot([1 1],[2 2],'s','LineWidth',2,... %线型为红色bai虚线，marker为方框，线粗细设定为2
'MarkerEdgeColor',[63 62 64]/255,... %marker边缘颜色设du定为黑色
'MarkerFaceColor',[49 49 49]/255,... %marker内部颜色设定为绿色
'MarkerSize',16)
hold on 
plot([1 1],[2 2],'s','LineWidth',2,... %线型为红色bai虚线，marker为方框，线粗细设定为2
'MarkerEdgeColor',[63 62 64]/255,... %marker边缘颜色设du定为黑色
'MarkerFaceColor',[93 93 93]/255,... %marker内部颜色设定为绿色
'MarkerSize',16)
plot([1 1],[2 2],'s','LineWidth',2,... %线型为红色bai虚线，marker为方框，线粗细设定为2
'MarkerEdgeColor',[63 62 64]/255,... %marker边缘颜色设du定为黑色
'MarkerFaceColor',[236 34 0]/255,... %marker内部颜色设定为绿色
'MarkerSize',16)
hold on 
plot([1 1],[2 2],'s','LineWidth',2,... %线型为红色bai虚线，marker为方框，线粗细设定为2
'MarkerEdgeColor',[63 62 64]/255,... %marker边缘颜色设du定为黑色
'MarkerFaceColor',[133 133 133]/255,... %marker内部颜色设定为绿色
'MarkerSize',16)
plot([1 1],[2 2],'s','LineWidth',2,... %线型为红色bai虚线，marker为方框，线粗细设定为2
'MarkerEdgeColor',[63 62 64]/255,... %marker边缘颜色设du定为黑色
'MarkerFaceColor',[169 169 169]/255,... %marker内部颜色设定为绿色
'MarkerSize',16)
hold on 
plot([1 1],[2 2],'s','LineWidth',2,... %线型为红色bai虚线，marker为方框，线粗细设定为2
'MarkerEdgeColor',[63 62 64]/255,... %marker边缘颜色设du定为黑色
'MarkerFaceColor',[203 203 203]/255,... %marker内部颜色设定为绿色
'MarkerSize',16)
plot([1 1],[2 2],'s','LineWidth',2,... %线型为红色bai虚线，marker为方框，线粗细设定为2
'MarkerEdgeColor',[63 62 64]/255,... %marker边缘颜色设du定为黑色
...
set(gca, 'XTick', [1.05,1.85,2.65]); % 添加X轴的记号点
